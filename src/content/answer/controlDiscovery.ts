...
const SELECTOR = "input[type=radio],input[type=checkbox],input:not([type]),input[type=text],textarea,[contenteditable=true],[role=radio],[role=checkbox],[role=option],[aria-checked],.option-item,.option,.choice-item,[data-option-key]";
